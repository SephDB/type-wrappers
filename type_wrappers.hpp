...
#define TYPE_WRAPPERS_WRAP_EXACT(...)  TYPE_WRAPPERS_WRAP_IMPL(BOOST_PP_VARIADIC_TO_LIST(__VA_ARGS__),0)
#define TYPE_WRAPPERS_WRAP_VARARG(...) TYPE_WRAPPERS_WRAP_IMPL(BOOST_PP_VARIADIC_TO_LIST(__VA_ARGS__),1)
