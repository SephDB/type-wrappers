...
#define TYPE_WRAPPERS_INSERT_ARGS(SEQ,VARARG,WRAPTYPE) BOOST_PP_SEQ_FOR_EACH_I(TYPE_WRAPPERS_GETARGNAME, TYPE_WRAPPERS_INSERT_ARGS_##WRAPTYPE, SEQ) BOOST_PP_EXPR_IIF(VARARG,...)
...
#define TYPE_WRAPPERS_ALL_TO_CLASS(SEQ) BOOST_PP_SEQ_TRANSFORM(TYPE_WRAPPERS_ALL_TO_CLASS_OP,_,SEQ)
...
#define TYPE_WRAPPERS_WRAP_EXACT(ARGS)  TYPE_WRAPPERS_WRAP_IMPL(ARGS,0)
#define TYPE_WRAPPERS_WRAP_VARARG(ARGS) TYPE_WRAPPERS_WRAP_IMPL(ARGS,1)

#define TYPE_WRAPPERS_UNWRAP_EXACT(ARGS) TYPE_WRAPPERS_UNWRAP_IMPL(ARGS,0)
#define TYPE_WRAPPERS_UNWRAP_VARARG(ARGS) TYPE_WRAPPERS_UNWRAP_IMPL(ARGS,1)
